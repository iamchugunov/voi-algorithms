...
%             dvx
            ...
            d(2,1) = 1/3 * (A - B);
%             dax
            A = dDdax(X,t,posts(:,3),posts(:,1))*s1+dDdax(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2dax(X,t,posts(:,3),posts(:,1)) + dD2dax(X,t,posts(:,3),posts(:,2)) - dDDdax(X,t,posts(:,3),posts(:,1),posts(:,2));
            d(3,1) = 1/3 * (A - B);
%             dy
...
%             vy
            ...
            d(5,1) = 1/3 * (A - B);
%             ay
            A = dDday(X,t,posts(:,3),posts(:,1))*s1+dDday(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2day(X,t,posts(:,3),posts(:,1)) + dD2day(X,t,posts(:,3),posts(:,2)) - dDDday(X,t,posts(:,3),posts(:,1),posts(:,2));
            d(6,1) = 1/3 * (A - B);
%             z
...
%             vz
            ...
            d(8,1) = 1/3 * (A - B);
%             az
            A = dDdaz(X,t,posts(:,3),posts(:,1))*s1+dDdaz(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2daz(X,t,posts(:,3),posts(:,1)) + dD2daz(X,t,posts(:,3),posts(:,2)) - dDDdaz(X,t,posts(:,3),posts(:,1),posts(:,2));
            d(9,1) = 1/3 * (A - B);
...
% %             dvx
            ...
            dd(1,2) = dd(2,1);
% %             dax
            A = dDdxdax(X,t,posts(:,3),posts(:,1))*s1+dDdxdax(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2dxdax(X,t,posts(:,3),posts(:,1)) + dD2dxdax(X,t,posts(:,3),posts(:,2)) - dDDdxdax(X,t,posts(:,3),posts(:,1),posts(:,2));
            dd(3,1) = 1/3 * (A - B);
            dd(1,3) = dd(3,1);
% %             dy
...
% %             dvy
            ...
            dd(1,5) = dd(5,1);
% %             day
            A = dDdxday(X,t,posts(:,3),posts(:,1))*s1+dDdxday(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2dxday(X,t,posts(:,3),posts(:,1)) + dD2dxday(X,t,posts(:,3),posts(:,2)) - dDDdxday(X,t,posts(:,3),posts(:,1),posts(:,2));
            dd(6,1) = 1/3 * (A - B);
            dd(1,6) = dd(6,1);
% %             dz
...
% %             dvz
            ...
            dd(1,8) = dd(8,1);
% %             daz
            A = dDdxdaz(X,t,posts(:,3),posts(:,1))*s1+dDdxdaz(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2dxdaz(X,t,posts(:,3),posts(:,1)) + dD2dxdaz(X,t,posts(:,3),posts(:,2)) - dDDdxdaz(X,t,posts(:,3),posts(:,1),posts(:,2));
            dd(9,1) = 1/3 * (A - B);
            dd(1,9) = dd(9,1);          
%             dvx
% %             dvx
            ...
            dd(2,2) = 1/3 * (A - B);
% %             dax
            A = dDdvxdax(X,t,posts(:,3),posts(:,1))*s1+dDdvxdax(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2dvxdax(X,t,posts(:,3),posts(:,1)) + dD2dvxdax(X,t,posts(:,3),posts(:,2)) - dDDdvxdax(X,t,posts(:,3),posts(:,1),posts(:,2));
            dd(3,2) = 1/3 * (A - B);
            dd(2,3) = dd(3,2);
% %             dy
...
% %             dvy
            ...
            dd(2,5) = dd(5,2);            
% %             day
            A = dDdvxday(X,t,posts(:,3),posts(:,1))*s1+dDdvxday(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2dvxday(X,t,posts(:,3),posts(:,1)) + dD2dvxday(X,t,posts(:,3),posts(:,2)) - dDDdvxday(X,t,posts(:,3),posts(:,1),posts(:,2));
            dd(6,2) = 1/3 * (A - B);
            dd(2,6) = dd(6,2);       
% %             dz
...
% %             dvz
            ...
            dd(2,8) = dd(8,2);            
% %             daz
            A = dDdvxdaz(X,t,posts(:,3),posts(:,1))*s1+dDdvxdaz(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2dvxdaz(X,t,posts(:,3),posts(:,1)) + dD2dvxdaz(X,t,posts(:,3),posts(:,2)) - dDDdvxdaz(X,t,posts(:,3),posts(:,1),posts(:,2));
            dd(9,2) = 1/3 * (A - B);
            dd(2,9) = dd(9,2);      
%             dax
% %             dax
            A = dDdaxdax(X,t,posts(:,3),posts(:,1))*s1+dDdaxdax(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2daxdax(X,t,posts(:,3),posts(:,1)) + dD2daxdax(X,t,posts(:,3),posts(:,2)) - dDDdaxdax(X,t,posts(:,3),posts(:,1),posts(:,2));
            dd(3,3) = 1/3 * (A - B);
% %             dy
            A = dDdydax(X,t,posts(:,3),posts(:,1))*s1+dDdydax(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2dydax(X,t,posts(:,3),posts(:,1)) + dD2dydax(X,t,posts(:,3),posts(:,2)) - dDDdydax(X,t,posts(:,3),posts(:,1),posts(:,2));
            dd(4,3) = 1/3 * (A - B);
            dd(3,4) = dd(4,3);    
% %             dvy
            A = dDdvydax(X,t,posts(:,3),posts(:,1))*s1+dDdvydax(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2dvydax(X,t,posts(:,3),posts(:,1)) + dD2dvydax(X,t,posts(:,3),posts(:,2)) - dDDdvydax(X,t,posts(:,3),posts(:,1),posts(:,2));
            dd(5,3) = 1/3 * (A - B);
            dd(3,5) = dd(5,3);            
% %             day
            A = dDdaxday(X,t,posts(:,3),posts(:,1))*s1+dDdaxday(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2daxday(X,t,posts(:,3),posts(:,1)) + dD2daxday(X,t,posts(:,3),posts(:,2)) - dDDdaxday(X,t,posts(:,3),posts(:,1),posts(:,2));
            dd(6,3) = 1/3 * (A - B);
            dd(3,6) = dd(6,3);             
% %             dz
            A = dDdzdax(X,t,posts(:,3),posts(:,1))*s1+dDdzdax(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2dzdax(X,t,posts(:,3),posts(:,1)) + dD2dzdax(X,t,posts(:,3),posts(:,2)) - dDDdzdax(X,t,posts(:,3),posts(:,1),posts(:,2));
            dd(7,3) = 1/3 * (A - B);
            dd(3,7) = dd(7,3);
% %             dvz
            A = dDdvzdax(X,t,posts(:,3),posts(:,1))*s1+dDdvzdax(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2dvzdax(X,t,posts(:,3),posts(:,1)) + dD2dvzdax(X,t,posts(:,3),posts(:,2)) - dDDdvzdax(X,t,posts(:,3),posts(:,1),posts(:,2));
            dd(8,3) = 1/3 * (A - B);
            dd(3,8) = dd(8,3);            
% %             daz
            A = dDdaxdaz(X,t,posts(:,3),posts(:,1))*s1+dDdaxdaz(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2daxdaz(X,t,posts(:,3),posts(:,1)) + dD2daxdaz(X,t,posts(:,3),posts(:,2)) - dDDdaxdaz(X,t,posts(:,3),posts(:,1),posts(:,2));
            dd(9,3) = 1/3 * (A - B);
            dd(3,9) = dd(9,3);
%             dy
% %             dy
...
% %             dvy
            ...
            dd(4,5) = dd(5,4);
% %             day
            A = dDdyday(X,t,posts(:,3),posts(:,1))*s1+dDdyday(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2dyday(X,t,posts(:,3),posts(:,1)) + dD2dyday(X,t,posts(:,3),posts(:,2)) - dDDdyday(X,t,posts(:,3),posts(:,1),posts(:,2));
            dd(6,4) = 1/3 * (A - B);
            dd(4,6) = dd(6,4);            
% %             dz
...
% %             dvz
            ...
            dd(4,8) = dd(8,4); 
% %             daz
            A = dDdydaz(X,t,posts(:,3),posts(:,1))*s1+dDdydaz(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2dydaz(X,t,posts(:,3),posts(:,1)) + dD2dydaz(X,t,posts(:,3),posts(:,2)) - dDDdydaz(X,t,posts(:,3),posts(:,1),posts(:,2));
            dd(9,4) = 1/3 * (A - B);
            dd(4,9) = dd(9,4);  
%             dvy
% %             dvy
            ...
            dd(5,5) = 1/3 * (A - B);
% %             day
            A = dDdvyday(X,t,posts(:,3),posts(:,1))*s1+dDdvyday(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2dvyday(X,t,posts(:,3),posts(:,1)) + dD2dvyday(X,t,posts(:,3),posts(:,2)) - dDDdvyday(X,t,posts(:,3),posts(:,1),posts(:,2));
            dd(6,5) = 1/3 * (A - B);
            dd(5,6) = dd(6,5);
% %             dz
...
% %             dvz
            ...
            dd(5,8) = dd(8,5);
% %             daz
            A = dDdvydaz(X,t,posts(:,3),posts(:,1))*s1+dDdvydaz(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2dvydaz(X,t,posts(:,3),posts(:,1)) + dD2dvydaz(X,t,posts(:,3),posts(:,2)) - dDDdvydaz(X,t,posts(:,3),posts(:,1),posts(:,2));
            dd(9,5) = 1/3 * (A - B);
            dd(5,9) = dd(9,5);
%             day
% %             day
            A = dDdayday(X,t,posts(:,3),posts(:,1))*s1+dDdayday(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2dayday(X,t,posts(:,3),posts(:,1)) + dD2dayday(X,t,posts(:,3),posts(:,2)) - dDDdayday(X,t,posts(:,3),posts(:,1),posts(:,2));
            dd(6,6) = 1/3 * (A - B);
% %             dz
            A = dDdzday(X,t,posts(:,3),posts(:,1))*s1+dDdzday(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2dzday(X,t,posts(:,3),posts(:,1)) + dD2dzday(X,t,posts(:,3),posts(:,2)) - dDDdzday(X,t,posts(:,3),posts(:,1),posts(:,2));
            dd(7,6) = 1/3 * (A - B);
            dd(6,7) = dd(7,6);    
% %             dvz
            A = dDdvzday(X,t,posts(:,3),posts(:,1))*s1+dDdvzday(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2dvzday(X,t,posts(:,3),posts(:,1)) + dD2dvzday(X,t,posts(:,3),posts(:,2)) - dDDdvzday(X,t,posts(:,3),posts(:,1),posts(:,2));
            dd(8,6) = 1/3 * (A - B);
            dd(6,8) = dd(8,6);
% %             daz            
            A = dDdaydaz(X,t,posts(:,3),posts(:,1))*s1+dDdaydaz(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2daydaz(X,t,posts(:,3),posts(:,1)) + dD2daydaz(X,t,posts(:,3),posts(:,2)) - dDDdaydaz(X,t,posts(:,3),posts(:,1),posts(:,2));
            dd(9,6) = 1/3 * (A - B);
            dd(6,9) = dd(9,6);
%             dz            
% %             dz
...
% %             dvz
            ...
            dd(7,8) = dd(8,7); 
% %             daz
            A = dDdzdaz(X,t,posts(:,3),posts(:,1))*s1+dDdzdaz(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2dzdaz(X,t,posts(:,3),posts(:,1)) + dD2dzdaz(X,t,posts(:,3),posts(:,2)) - dDDdzdaz(X,t,posts(:,3),posts(:,1),posts(:,2));
            dd(9,7) = 1/3 * (A - B);
            dd(7,9) = dd(9,7);   
%             dvz            
% %             dvz
            ...
            dd(8,8) = 1/3 * (A - B);
% %             daz
            A = dDdvzdaz(X,t,posts(:,3),posts(:,1))*s1+dDdvzdaz(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2dvzdaz(X,t,posts(:,3),posts(:,1)) + dD2dvzdaz(X,t,posts(:,3),posts(:,2)) - dDDdvzdaz(X,t,posts(:,3),posts(:,1),posts(:,2));
            dd(9,8) = 1/3 * (A - B);
            dd(8,9) = dd(9,8); 
%             daz  
% %             daz
            A = dDdazdaz(X,t,posts(:,3),posts(:,1))*s1+dDdazdaz(X,t,posts(:,3),posts(:,2))*s2;
            B = dD2dazdaz(X,t,posts(:,3),posts(:,1)) + dD2dazdaz(X,t,posts(:,3),posts(:,2)) - dDDdazdaz(X,t,posts(:,3),posts(:,1),posts(:,2));
            dd(9,9) = 1/3 * (A - B);     
...
%             dvx
            ...
            d(2,1) = 1/2 * A - 1/4 * B;
%             dax
            A = dDdax(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2dax(X,t,posts(:,2),posts(:,1));
            d(3,1) = 1/2 * A - 1/4 * B;
%             dy
...
%             vy
            ...
            d(5,1) = 1/2 * A - 1/4 * B;
%             ay
            A = dDday(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2day(X,t,posts(:,2),posts(:,1));
            d(6,1) = 1/2 * A - 1/4 * B;
%             z
...
%             vz
            ...
            d(8,1) = 1/2 * A - 1/4 * B;
%             az
            A = dDdaz(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2daz(X,t,posts(:,2),posts(:,1));
            d(9,1) = 1/2 * A - 1/4 * B;
...
% %             dvx
            ...
            dd(1,2) = dd(2,1);
% %             dax
            A = dDdxdax(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2dxdax(X,t,posts(:,2),posts(:,1));
            dd(3,1) = 1/2 * A - 1/4 * B;
            dd(1,3) = dd(3,1);
% %             dy
...
% %             dvy
            ...
            dd(1,5) = dd(5,1);
% %             day
            A = dDdxday(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2dxday(X,t,posts(:,2),posts(:,1));
            dd(6,1) = 1/2 * A - 1/4 * B;
            dd(1,6) = dd(6,1);
% %             dz
...
% %             dvz
            ...
            dd(1,8) = dd(8,1);
% %             daz
            A = dDdxdaz(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2dxdaz(X,t,posts(:,2),posts(:,1));
            dd(9,1) = 1/2 * A - 1/4 * B;
            dd(1,9) = dd(9,1);          
%             dvx
% %             dvx
            ...
            dd(2,2) = 1/2 * A - 1/4 * B;
% %             dax
            A = dDdvxdax(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2dvxdax(X,t,posts(:,2),posts(:,1));
            dd(3,2) = 1/2 * A - 1/4 * B;
            dd(2,3) = dd(3,2);
% %             dy
...
% %             dvy
            ...
            dd(2,5) = dd(5,2);            
% %             day
            A = dDdvxday(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2dvxday(X,t,posts(:,2),posts(:,1));
            dd(6,2) = 1/2 * A - 1/4 * B;
            dd(2,6) = dd(6,2);       
% %             dz
...
% %             dvz
            ...
            dd(2,8) = dd(8,2);            
% %             daz
            A = dDdvxdaz(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2dvxdaz(X,t,posts(:,2),posts(:,1));
            dd(9,2) = 1/2 * A - 1/4 * B;
            dd(2,9) = dd(9,2);      
%             dax
% %             dax
            A = dDdaxdax(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2daxdax(X,t,posts(:,2),posts(:,1));
            dd(3,3) = 1/2 * A - 1/4 * B;
% %             dy
            A = dDdydax(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2dydax(X,t,posts(:,2),posts(:,1));
            dd(4,3) = 1/2 * A - 1/4 * B;
            dd(3,4) = dd(4,3);    
% %             dvy
            A = dDdvydax(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2dvydax(X,t,posts(:,2),posts(:,1));
            dd(5,3) = 1/2 * A - 1/4 * B;
            dd(3,5) = dd(5,3);            
% %             day
            A = dDdaxday(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2daxday(X,t,posts(:,2),posts(:,1));
            dd(6,3) = 1/2 * A - 1/4 * B;
            dd(3,6) = dd(6,3);             
% %             dz
            A = dDdzdax(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2dzdax(X,t,posts(:,2),posts(:,1));
            dd(7,3) = 1/2 * A - 1/4 * B;
            dd(3,7) = dd(7,3);
% %             dvz
            A = dDdvzdax(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2dvzdax(X,t,posts(:,2),posts(:,1));
            dd(8,3) = 1/2 * A - 1/4 * B;
            dd(3,8) = dd(8,3);            
% %             daz
            A = dDdaxdaz(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2daxdaz(X,t,posts(:,2),posts(:,1));
            dd(9,3) = 1/2 * A - 1/4 * B;
            dd(3,9) = dd(9,3);
%             dy
% %             dy
...
% %             dvy
            ...
            dd(4,5) = dd(5,4);
% %             day
            A = dDdyday(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2dyday(X,t,posts(:,2),posts(:,1));
            dd(6,4) = 1/2 * A - 1/4 * B;
            dd(4,6) = dd(6,4);            
% %             dz
...
% %             dvz
            ...
            dd(4,8) = dd(8,4); 
% %             daz
            A = dDdydaz(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2dydaz(X,t,posts(:,2),posts(:,1));
            dd(9,4) = 1/2 * A - 1/4 * B;
            dd(4,9) = dd(9,4);  
%             dvy
% %             dvy
            ...
            dd(5,5) = 1/2 * A - 1/4 * B;
% %             day
            A = dDdvyday(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2dvyday(X,t,posts(:,2),posts(:,1));
            dd(6,5) = 1/2 * A - 1/4 * B;
            dd(5,6) = dd(6,5);
% %             dz
...
% %             dvz
            ...
            dd(5,8) = dd(8,5);
% %             daz
            A = dDdvydaz(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2dvydaz(X,t,posts(:,2),posts(:,1));
            dd(9,5) = 1/2 * A - 1/4 * B;
            dd(5,9) = dd(9,5);
%             day
% %             day
            A = dDdayday(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2dayday(X,t,posts(:,2),posts(:,1));
            dd(6,6) = 1/2 * A - 1/4 * B;
% %             dz
            A = dDdzday(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2dzday(X,t,posts(:,2),posts(:,1));
            dd(7,6) = 1/2 * A - 1/4 * B;
            dd(6,7) = dd(7,6);    
% %             dvz
            A = dDdvzday(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2dvzday(X,t,posts(:,2),posts(:,1));
            dd(8,6) = 1/2 * A - 1/4 * B;
            dd(6,8) = dd(8,6);
% %             daz            
            A = dDdaydaz(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2daydaz(X,t,posts(:,2),posts(:,1));
            dd(9,6) = 1/2 * A - 1/4 * B;
            dd(6,9) = dd(9,6);
%             dz            
% %             dz
...
% %             dvz
            ...
            dd(7,8) = dd(8,7); 
% %             daz
            A = dDdzdaz(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2dzdaz(X,t,posts(:,2),posts(:,1));
            dd(9,7) = 1/2 * A - 1/4 * B;
            dd(7,9) = dd(9,7);   
%             dvz            
% %             dvz
            ...
            dd(8,8) = 1/2 * A - 1/4 * B;
% %             daz
            A = dDdvzdaz(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2dvzdaz(X,t,posts(:,2),posts(:,1));
            dd(9,8) = 1/2 * A - 1/4 * B;
            dd(8,9) = dd(9,8); 
%             daz  
% %             daz
            A = dDdazdaz(X,t,posts(:,2),posts(:,1))*rd1;
            B = dD2dazdaz(X,t,posts(:,2),posts(:,1));
            dd(9,9) = 1/2 * A - 1/4 * B;
    end
end
